...
`endif
  ...
  assign stage_ready[2] = !n2_valid || stage_ready[3];
  ...
  assign pipeline_empty = stage_valid == 6'b000000;
    ...
    if (rst) begin
      ...
      if (stage_ready[3]) begin
        ...
        if (n2_valid) begin
          n3_neuron <= n2_neuron;
          n3_tick <= n2_tick;
          n3_threshold <= n2_threshold;
          n3_reset <= n2_reset;
          n3_decay <= n2_decay_value;
          n3_candidate <= n2_candidate_value;
          n3_accumulator_saturated <= n2_accumulator_saturated;
          n3_membrane_saturated <= n2_membrane_saturated;
        end
      end
