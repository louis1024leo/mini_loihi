module mini_loihi_core_readycut #(
  ...
  output logic debug_cut_in_ready,
  output logic debug_cut_out_valid,
  output logic [1:0] debug_cut_occupancy,
...
`endif
  ...
  lif_pipeline_readycut neuron_pipeline (
    .clk(clk), .rst(rst),
    ...
    .cut_in_ready(debug_cut_in_ready), .cut_out_valid(debug_cut_out_valid),
    .cut_occupancy(debug_cut_occupancy), .stage_valid(debug_pipeline_valid),
