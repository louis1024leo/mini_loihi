module mini_loihi_v81c_alif_image_top #(
  ...
  mini_loihi_v81c_alif_core #(
    ...
    .NEURON_ADAPTATION_INIT(NEURON_ADAPTATION_INIT),
    .NEURON_TIMESTAMP_INIT(NEURON_TIMESTAMP_INIT),
    ...
    .NEURON_MODEL_INIT(NEURON_MODEL_INIT),
    .NEURON_TYPE_INIT(NEURON_TYPE_INIT),
